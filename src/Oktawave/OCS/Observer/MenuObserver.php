...
class Oktawave_OCS_Observer_MenuObserver
{
    ...
    {
        add_menu_page(
                __('Oktawave OCS', 'ocs_oktawave'), __('Oktawave OCS', 'ocs_oktawave'), 'manage_options', 'oktawave_ocs_settings', array($this->settings, 'settingsPage'), plugins_url('oktawave-ocs/images/icon.ico')
        );
